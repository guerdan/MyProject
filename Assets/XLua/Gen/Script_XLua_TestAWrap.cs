...
namespace XLua.CSObjectWrap
{
    ...
    public class ScriptXLuaTestAWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Script.XLua.TestA);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Script.XLua.TestA();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Script.XLua.TestA constructor!");
        ...
        static int _m_DirectCall(RealStatePtr L)
        {
		    try {
                ...
                Script.XLua.TestA gen_to_be_invoked = (Script.XLua.TestA)translator.FastGetCSObj(L, 1);
